...
/**
 * DTO ответа Avito API UpdateTerms.
 */
class UpdateTermsResponse extends AbstractResponse
{
    ...
    protected const MODEL = \Andy87\ClientsAvito\Generated\Schema\DeliverySandbox\UpdateTermsReply::class;
