...
/**
 * DTO ответа Avito API customAreaSchedule.
 */
class CustomAreaScheduleResponse extends AbstractResponse
{
    ...
    protected const MODEL = \Andy87\ClientsAvito\Generated\Schema\DeliverySandbox\AddTaskReply::class;
