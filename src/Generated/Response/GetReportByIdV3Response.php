...
/**
 * Ответ Avito API [GET] /autoload/v3/reports/{report_id}.
 *
 * @documentation https://developers.avito.ru/api-catalog/autoload/documentation#operation/getReportByIdV3
 */
class GetReportByIdV3Response extends AbstractResponse
{
    protected const FIELD_MAP = ['events' => 'events', 'feeds_urls' => 'feeds_urls', 'finished_at' => 'finished_at', 'listing_fees' => 'listing_fees', 'report_id' => 'report_id', 'section_stats' => 'section_stats', 'source' => 'source', 'started_at' => 'started_at', 'status' => 'status'];
    ...
    protected const MODEL = \and_y87\php_client_avito\Generated\Schema\Autoload\ReportAutoloadV3::class;

    /** @var array<int, array<string, mixed>> Ошибки и предупреждения, которые относятся ко всей выгрузке */
    public array $events;

    /** @var array<int, array<string, mixed>>|null Response field feeds_urls */
    public ?array $feeds_urls = null;
