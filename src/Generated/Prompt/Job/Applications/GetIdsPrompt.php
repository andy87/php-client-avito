...
use and_y87\php_client_avito\Generated\Prompt\ApplicationsGetIdsPrompt as BaseApplicationsGetIdsPrompt;
 ...
 *
 * @property bool|null $X_Is_Employee Сотрудник может получить список его откликов для вакансий которые он разместил в рамках компании
