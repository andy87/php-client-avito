...
namespace php_client_avito\Generated\Prompt\OrderManagement\Orders;

use php_client_avito\Generated\Prompt\GetOrdersPrompt as BaseGetOrdersPrompt;
 ...
 * @property array<int, \php_client_avito\Generated\Schema\OrderManagement\Status>|null $statuses Статус, по которому нужно получить заказы. - on_confirmation - ожидает подтверждения - ready_to_ship - ждет отправки - in_transit - в пути - canceled - отменный заказ - delivered - доставлен покупателю - on_return - на возврате - in_dispute - по заказу открыт спор - closed - заказ закрыт
