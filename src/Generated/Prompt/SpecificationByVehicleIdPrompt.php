...
/**
 * DTO запроса Avito API specificationByVehicleId.
 */
class SpecificationByVehicleIdPrompt extends AbstractPrompt
{
    protected const METHOD = 'POST';

    protected const ENDPOINT = '/autoteka/v1/specifications/by-vehicle-id';
