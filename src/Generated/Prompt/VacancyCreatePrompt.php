 ...
 */
class VacancyCreatePrompt extends AbstractPrompt
{
    protected const METHOD = 'POST';

    protected const ENDPOINT = '/job/v1/vacancies';
    ...
    protected const BODY_FIELDS = ['address', 'administrator_organization_type', 'age', 'age_preferences', 'allow_calls', 'allow_messages', 'apply_processing', 'billing_type', 'bonuses', 'business_area', 'citizenship', 'construction_work_type', 'contacts', 'coordinates', 'cuisine', 'custom_employer_name', 'delivery_method', 'description', 'driving_experience', 'driving_license_category', 'eatery_type', 'education_level', 'employee_id', 'employment', 'experience', 'facility_type', 'food_production_shop_type', 'grade', 'html_tags', 'image_url', 'is_company_car', 'is_side_job', 'medical_book', 'medical_specialization', 'medical_specialization_ids', 'name', 'payout_frequency', 'profession', 'registration_method', 'retail_equipment_type', 'retail_shop_type', 'salary', 'salary_detail', 'salary_range', 'schedule', 'shifts', 'tools_availability', 'vacancy_code', 'vehicle_type', 'work_days_per_week', 'work_format', 'work_hours_per_day', 'worker_class'];
 ...
 */
    ...
    /** @var \Andy87\ClientsAvito\Generated\Schema\Job\BusinessArea Body field business_area */
