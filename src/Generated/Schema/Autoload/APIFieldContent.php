...
class APIFieldContent extends AbstractSchemaModel
{
    ...
    protected const CASTS = ['defaultValue' => \and_y87\php_client_avito\Generated\Schema\Autoload\FieldValue::class, 'dependencies' => [\and_y87\php_client_avito\Generated\Schema\Autoload\APIDependency::class], 'values' => [\and_y87\php_client_avito\Generated\Schema\Autoload\FieldValue::class], 'values_range' => \and_y87\php_client_avito\Generated\Schema\Autoload\FieldValueRange::class, 'warnings' => [\and_y87\php_client_avito\Generated\Schema\Autoload\FieldWarning::class]];

    /** @var string Тип данных в поле. */
    public string $data_type;

    /** @var \and_y87\php_client_avito\Generated\Schema\Autoload\FieldValue|null Schema field default */
    public ?\and_y87\php_client_avito\Generated\Schema\Autoload\FieldValue $defaultValue = null;

    /** @var array<int, \and_y87\php_client_avito\Generated\Schema\Autoload\APIDependency>|null Список зависимостей одного поля от других. Информация в этих объектах нужна для определения, какое именно правило заполнения поля применить. */
 ...
 */
    ...
    /** @var array<int, \and_y87\php_client_avito\Generated\Schema\Autoload\FieldValue>|null Список возможных значений для поля. */
 ...
 */
    ...
    /** @var \and_y87\php_client_avito\Generated\Schema\Autoload\FieldValueRange|null Schema field values_range */
    public ?\and_y87\php_client_avito\Generated\Schema\Autoload\FieldValueRange $values_range = null;

    /** @var array<int, \and_y87\php_client_avito\Generated\Schema\Autoload\FieldWarning>|null Schema field warnings */
