...
class ItemInfoAutoload extends AbstractSchemaModel
{
    ...
    protected const CASTS = ['alarm' => [\and_y87\php_client_avito\Generated\Schema\Autoload\ItemInfoErrorAutoload::class], 'errors' => [\and_y87\php_client_avito\Generated\Schema\Autoload\ItemInfoErrorAutoload::class], 'warnings' => [\and_y87\php_client_avito\Generated\Schema\Autoload\ItemInfoErrorAutoload::class]];

    /** @var array<int, \and_y87\php_client_avito\Generated\Schema\Autoload\ItemInfoErrorAutoload>|null Ошибки, при которых публикация/обновление происходит, но при этом с объявлением есть проблема, которая требует вмешательства пользователя; публикация изменений, по-возможности, происходит */
 ...
 */
    ...
    /** @var array<int, \and_y87\php_client_avito\Generated\Schema\Autoload\ItemInfoErrorAutoload>|null Ошибки, при возникновении которых публикация новых не происходит, уже опубликованные — остаются без изменений, VAS-услуги не применяются, завершенные — не реактивируются */
 ...
 */
    ...
    /** @var array<int, \and_y87\php_client_avito\Generated\Schema\Autoload\ItemInfoErrorAutoload>|null Ошибки, которые, в подавляющем большинстве случаев, информируют, но не требуют вмешательства (никак не влияют на статус обработки) */
