...
class ItemInfoReportAutoloadV2 extends AbstractSchemaModel
{
    ...
    protected const CASTS = ['applied_vas' => [\and_y87\php_client_avito\Generated\Schema\Autoload\ItemInfoVas::class], 'messages' => [\and_y87\php_client_avito\Generated\Schema\Autoload\ItemInfoError::class]];

    /** @var string Идентификатор объявления из файла ([параметр Id](https://autoload.avito.ru/format/realty/#Id))
 */
    public string $ad_id;

    /** @var array<int, \and_y87\php_client_avito\Generated\Schema\Autoload\ItemInfoVas>|null Список примененных в конкретной выгрузке [услуг продвижения](https://support.avito.ru/partitions/131) */
 ...
 */
    ...
    /** @var array<int, \and_y87\php_client_avito\Generated\Schema\Autoload\ItemInfoError> Ошибки или предупреждения по объявлению */
