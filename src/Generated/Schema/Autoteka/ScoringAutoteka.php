...
class ScoringAutoteka extends AbstractSchemaModel
{
    ...
    protected const CASTS = ['data' => \and_y87\php_client_avito\Generated\Schema\Autoteka\ScoringDataAutoteka::class];

    /** @var int Дата формирования отчета */
    public int $createdAt;

    /** @var \and_y87\php_client_avito\Generated\Schema\Autoteka\ScoringDataAutoteka|null Schema field data */
    public ?\and_y87\php_client_avito\Generated\Schema\Autoteka\ScoringDataAutoteka $data = null;
