...
class DiagnosticsEvent extends AbstractSchemaModel
{
    ...
    protected const CASTS = ['damages' => [\and_y87\php_client_avito\Generated\Schema\Autoteka\DiagnosticsEventDamage::class], 'photos' => [\and_y87\php_client_avito\Generated\Schema\Autoteka\DiagnosticsEventPhoto::class]];
    ...
    /** @var array<int, \and_y87\php_client_avito\Generated\Schema\Autoteka\DiagnosticsEventDamage> Массив событий с найденными на ДО повреждениями а/м */
    ...
    /** @var array<int, \and_y87\php_client_avito\Generated\Schema\Autoteka\DiagnosticsEventPhoto> Массив фотографий с ДО */
    public array $photos;
