...
/**
 * OpenAPI schema модель Avito delivery-sandbox/DeliverySetOrderRealAddresseReply.
 */
class DeliverySetOrderRealAddresseReply extends AbstractSchemaModel
{
    ...
    protected const CASTS = ['error' => \and_y87\php_client_avito\Generated\Schema\DeliverySandbox\DeliveryError::class];
