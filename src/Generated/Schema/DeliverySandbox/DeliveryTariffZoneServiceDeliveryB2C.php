...
/**
 * OpenAPI schema модель Avito delivery-sandbox/DeliveryTariffZone-ServiceDeliveryB2C.
 */
class DeliveryTariffZoneServiceDeliveryB2C extends AbstractSchemaModel
{
    protected const FIELD_MAP = ['calculationMechanic' => 'calculationMechanic', 'chargeableParameter' => 'chargeableParameter', 'serviceName' => 'serviceName'];

    protected const REQUIRED_FIELDS = ['serviceName', 'calculationMechanic', 'chargeableParameter'];
 ...
 */
    ...
    /** @var string Услуга доставки B2C */
