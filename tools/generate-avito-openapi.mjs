...
function documentationUrl(meta) {
    return `https://developers.avito.ru/api-catalog/${meta.slug}/documentation#operation/${meta.operationId}`;
}

function operationClassDoc(meta, kind) {
    const title = kind === 'prompt'
        ? 'Класс данных запроса Avito API'
        : 'Ответ Avito API';
...
function buildPrompt(spec, op, meta) {
    ...
    return classFile({
        ...
        constants: {
            ...
            AUTHORIZATION_REQUIRED: operationRequiresAuthorization(spec, op),
